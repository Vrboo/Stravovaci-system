...
public class AdministratorInterface extends JFrame {
    ...
    private void initComponents() {
        ...
        btnJedalnyListokRanajok = new KButton();
        btnJedalnyListokObed = new KButton();
        btnJedalnyListokVytvoriťMenu = new KButton();
                        ...
                        //======== panelJedalnyListok ========
                        {
                            ...
                            //======== splitPane4 ========
                            {
                                ...
                                //======== panelMenuJedalnyListok ========
                                {
                                    ...
                                    //---- btnJedalnyListokRanajok ----
                                    btnJedalnyListokRanajok.setText("Ranajky");
                                    btnJedalnyListokRanajok.setBorder(null);
                                    btnJedalnyListokRanajok.setFont(new Font("Yu Gothic UI", Font.BOLD, 17));
                                    btnJedalnyListokRanajok.setkStartColor(Color.darkGray);
                                    btnJedalnyListokRanajok.setkEndColor(Color.darkGray);
                                    btnJedalnyListokRanajok.setkBorderRadius(0);
                                    btnJedalnyListokRanajok.setkAllowTab(true);
                                    btnJedalnyListokRanajok.setkHoverEndColor(new Color(70, 70, 70));
                                    btnJedalnyListokRanajok.setkHoverStartColor(new Color(70, 70, 70));
                                    btnJedalnyListokRanajok.setkIndicatorColor(new Color(38, 184, 190));
                                    btnJedalnyListokRanajok.setkIndicatorThickness(0);
                                    btnJedalnyListokRanajok.setkBackGroundColor(Color.white);
                                    btnJedalnyListokRanajok.setkSelectedColor(new Color(67, 67, 67));
                                    btnJedalnyListokRanajok.setkHoverForeGround(Color.white);
                                    btnJedalnyListokRanajok.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
                                    btnJedalnyListokRanajok.setVerticalAlignment(SwingConstants.TOP);
                                    btnJedalnyListokRanajok.addActionListener(e -> {
			btnRanajkyActionPerformed();
			btnRanajkyActionPerformed();
		});
                                    panelMenuJedalnyListok.add(btnJedalnyListokRanajok, CC.xy(1, 1));

                                    //---- btnJedalnyListokObed ----
                                    btnJedalnyListokObed.setText("Obed");
                                    btnJedalnyListokObed.setBorder(null);
                                    btnJedalnyListokObed.setFont(new Font("Yu Gothic UI", Font.BOLD, 17));
                                    btnJedalnyListokObed.setkStartColor(Color.darkGray);
                                    btnJedalnyListokObed.setkEndColor(Color.darkGray);
                                    btnJedalnyListokObed.setkBorderRadius(0);
                                    btnJedalnyListokObed.setkAllowTab(true);
                                    btnJedalnyListokObed.setkHoverEndColor(new Color(70, 70, 70));
                                    btnJedalnyListokObed.setkHoverStartColor(new Color(70, 70, 70));
                                    btnJedalnyListokObed.setkIndicatorColor(new Color(38, 184, 190));
                                    btnJedalnyListokObed.setkIndicatorThickness(0);
                                    btnJedalnyListokObed.setkBackGroundColor(Color.white);
                                    btnJedalnyListokObed.setkSelectedColor(new Color(67, 67, 67));
                                    btnJedalnyListokObed.setkHoverForeGround(Color.white);
                                    btnJedalnyListokObed.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
                                    btnJedalnyListokObed.setVerticalAlignment(SwingConstants.TOP);
                                    btnJedalnyListokObed.addActionListener(e -> btnObedActionPerformed());
                                    panelMenuJedalnyListok.add(btnJedalnyListokObed, CC.xy(3, 1));

                                    //---- btnJedalnyListokVytvoriťMenu ----
                                    btnJedalnyListokVytvoriťMenu.setText("Vytvori\u0165");
                                    btnJedalnyListokVytvoriťMenu.setBorder(null);
                                    btnJedalnyListokVytvoriťMenu.setFont(new Font("Yu Gothic UI", Font.BOLD, 17));
                                    btnJedalnyListokVytvoriťMenu.setkStartColor(Color.darkGray);
                                    btnJedalnyListokVytvoriťMenu.setkEndColor(Color.darkGray);
                                    btnJedalnyListokVytvoriťMenu.setkBorderRadius(0);
                                    btnJedalnyListokVytvoriťMenu.setkAllowTab(true);
                                    btnJedalnyListokVytvoriťMenu.setkHoverEndColor(new Color(70, 70, 70));
                                    btnJedalnyListokVytvoriťMenu.setkHoverStartColor(new Color(70, 70, 70));
                                    btnJedalnyListokVytvoriťMenu.setkIndicatorColor(new Color(38, 184, 190));
                                    btnJedalnyListokVytvoriťMenu.setkIndicatorThickness(0);
                                    btnJedalnyListokVytvoriťMenu.setkBackGroundColor(Color.white);
                                    btnJedalnyListokVytvoriťMenu.setkSelectedColor(new Color(67, 67, 67));
                                    btnJedalnyListokVytvoriťMenu.setkHoverForeGround(Color.white);
                                    btnJedalnyListokVytvoriťMenu.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
                                    btnJedalnyListokVytvoriťMenu.setVerticalAlignment(SwingConstants.TOP);
                                    btnJedalnyListokVytvoriťMenu.addActionListener(e -> btnObedActionPerformed());
                                    panelMenuJedalnyListok.add(btnJedalnyListokVytvoriťMenu, CC.xy(5, 1));
                                }
                                ...
                                //======== panelContentJedalnyListok ========
                                {
                                    ...
                                    //======== panelJedalnyListokRanajky ========
                                    {
                                        ...
                                        //======== panelJedalnyListokRanajkyInside ========
                                        {
                                            ...
                                            panelJedalnyListokRanajkyInside.add(label88, CC.xy(1, 8));
                                        }
                                        panelJedalnyListokRanajky.add(panelJedalnyListokRanajkyInside, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0,
                                            GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                                            new Insets(0, 0, 0, 0), 0, 0));
                                    }
    ...
    private KButton btnJedalnyListokRanajok;
    private KButton btnJedalnyListokObed;
    private KButton btnJedalnyListokVytvoriťMenu;
